...
- `fetch_text_from_url`: loads document text from an URL into the conversation. Do not
  guess line counts or positions-ground them in tool results from saved file."""


@tool
def fetch_text_from_url(url: str) -> str:
    """ Fetch the document from an URL.
    """
